...
**Project-specific skills** (installed to `.claude/skills/` during init, not overwritten on update):
...
- Check `.claude/skills/` for any additional project-specific skills
