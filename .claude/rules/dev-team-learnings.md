...
- **FULL reviews must include Brooks alongside Szabo and Knuth.** v3.8.0 excluded Brooks from all 8 review rounds despite CLAUDE.md stating "Szabo, Knuth, and Brooks review all code changes." Brooks ran the batch pre-assessment but pre-assessment is not review — it doesn't examine the implementation diff. The 4 COMPLEX PRs (#773, #781, #787, #795) all involved architectural boundary changes that Brooks is specifically designed to catch.
