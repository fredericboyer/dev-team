...
- **"Require up-to-date branches" protection creates merge cascades.** Each merge makes other PRs stale, requiring sequential rebase+push. Mergify merge queue handles this automatically (configured in v3.2.0, `.mergify.yml`).
