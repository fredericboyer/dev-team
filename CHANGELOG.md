...
- Missing test assertion for security-status project-specific skill (#187).

### Internal
- 276 tests (was 274). 5 framework skills + 2 project-specific skills. 12 agents. ADR-019 amended for agent teams.
...
- **Project-specific skill separation** -- merge and security-status moved to project-specific skills (#152).

### Changed
- Templates provide capabilities, not workflow opinions (#152).
- Framework skills to .dev-team/skills/, project-specific skills to .claude/skills/ (#152).
...
### Internal
- 274 tests (was 262). 5 framework skills + 2 project-specific skills. 12 agents.
