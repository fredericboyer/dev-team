...
export async function update(targetDir: string): Promise<void> {
  ...
  // Backfill models config — merge existing user values with defaults (additive only)
  prefs.models = prefs.models ? mergeModelsConfig(prefs.models) : mergeModelsConfig({});
